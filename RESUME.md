...
**מקור האמת היחיד להמשך העבודה.** עודכן: 2026-06-14 (נקודות כניסה לדף הבית + העברת ה-feed ל-GitHub Actions).

> 🆕 **סשן 14/6:** הסיכום המלא של הסשן האחרון (רצועת "משחקי היום" + באנר דו-שלבי חיים בפרודקשן, רענון ה-feed עבר לענן) → **`SESSION-HANDOFF-2026-06-14-homepage-entrypoints-and-cloud-feed.md`**.
