...
export const RESULT_OVERRIDES = [
  ...
  // FINAL: Spain beat Argentina 1-0 (Torres 106', extra time). openfootball logged the 90' 0-0,
  // which renders as a drawn, championless final. Pin the real result so Spain is crowned.
  { stage: 'final', t1: 'ESP', t2: 'ARG', score: [1, 0], note: 'ESP 1-0 ARG (Torres 106, AET) - World Cup final' },
];
